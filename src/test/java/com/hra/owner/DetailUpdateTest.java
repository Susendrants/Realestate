...
public class DetailUpdateTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String s= sh.getRow(7).getCell(3).getStringCellValue()+ram;
		driver.findElement(By.xpath("//input[@name=\"mobile\"]")).sendKeys(s);
		driver.findElement(By.xpath("//h2[text()='Register Room']/parent::div[@class=\"alert alert-info\"]/descendant::input[@name=\"email\"]")).sendKeys(sh.getRow(8).getCell(3).getStringCellValue()+ram);
